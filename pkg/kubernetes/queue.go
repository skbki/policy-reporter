...
import (
	...
	pr "github.com/skbki/policy-reporter/pkg/crd/api/policyreport/v1alpha2"
	"github.com/skbki/policy-reporter/pkg/crd/client/clientset/versioned/typed/policyreport/v1alpha2"
